...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.instance_images_path = [img for ext in ['*.jpg', '*.png'] for img in Path(self.instance_data_root).rglob(ext)]
    ...
    def __getitem__(self, index):
        ...
        if self.resize_ratios is not None:
            resize_ratio = np.random.choice(self.resize_ratios)
            new_size = (int(instance_image.width * resize_ratio), int(instance_image.height * resize_ratio))
            instance_image = instance_image.resize(new_size, Image.BILINEAR)
...
def main(args):
    ...
    train_dataset = DreamBoothDataset(
        ...
        resize_ratios=args.resize_ratios,
